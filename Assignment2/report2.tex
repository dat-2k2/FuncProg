...
В этом задание надо реалозовать рекурсивное решение задачи <<О Ладях>>:  вычислить количество расположений $n$ ладей на шашечнице из $n^2$ клеток, при которых ни одна ладья не угрожает другой, и перечислить они. При этой проблема существуют 2 варианты: базовый и более сложный: диагонал блокируют. 

\newpage 
\section{Математическое 
\end{document}